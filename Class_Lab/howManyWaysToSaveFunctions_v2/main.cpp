...
float save4(float,float,float);//overload function call,i.e. same name
...
int main(int argc, char** argv) {
    ...
    float futrVal;//reference variable passed into save 5
    int count;//count how many times save 5 is called
